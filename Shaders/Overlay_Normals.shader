...
// Improved with SPS-I support, Fullscreen "screenspace" mode, billboard sphere mode, border dissolve effect
    ...
    SubShader {
        ...
        Pass {
            ...
            float3 position_vs_at_pixel(float2 pixel_position) {
                ...
                #endif
                const float4 v = mul(unity_birp_MatrixInvP, float4(clipPos, raw, 1));
                return v.xyz / v.w;
            }
